        ...
        <form className="flex flex-1 flex-col">
          ...
          <div className="flex items-center">
            <div className="flex flex-1 space-x-2 text-twitter">
              ...
              <SearchCircleIcon className="h5 w-5  cursor-pointer transition-transform duration-150 ease-out hover:scale-150" />
              <EmojiHappyIcon className="h5 w-5  cursor-pointer transition-transform duration-150 ease-out hover:scale-150" />
              <CalendarIcon className="h5 w-5  cursor-pointer transition-transform duration-150 ease-out hover:scale-150" />
